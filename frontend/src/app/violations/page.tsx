// /home/vilkas/atradimai/dienynas/frontend/src/app/violations/page.tsx

// Pagrindinis pažeidimų/skolų valdymo puslapis
// Pateikia greitųjų veiksmų mygtukus ir bendrą mokyklos statistiką
// CHANGE: Sukurtas pagrindinis violations puslapis su greitaisiais mygtukais ir statistikos komponentais
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Skolų valdymas</h1>
          <p className="text-gray-600 mt-1">Pažeidimų ir skolų valdymo sistema</p>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {/* Skolų valdymas */}
            <Link href="/violations/management" className="block">
            ...
            {/* Detali analizė */}
            <Link href="/violations/analytics" className="block">
              <button className="text-left p-4 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors w-full">
                <div className="flex items-center space-x-3">

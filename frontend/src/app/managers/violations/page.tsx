// /home/vilkas/atradimai/dienynas/frontend/src/app/managers/violations/page.tsx

// Managerių pagrindinis pažeidimų/skolų puslapis
...
export default function ManagerViolationsPage() {
  const { user } = useAuth();
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {/* Skolų valdymas */}
                <Link href="/managers/violations/management" className="block">
                ...
                {/* Detali analizė */}
                <Link href="/managers/violations/analytics" className="block">
                  <button className="text-left p-4 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors w-full">
                    <div className="flex items-center space-x-3">

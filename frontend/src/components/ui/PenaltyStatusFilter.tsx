// frontend/src/components/ui/PenaltyStatusFilter.tsx

// Modernaus jungiklio komponentas mokėjimo statusų filtravimui
// Palaiko 3 būsenas: -1 (Neapmokėta), 0 (Visi), 1 (Apmokėta)
// CHANGE: Sukurtas specialiai penalty_status filtravimui

'use client';

import React from 'react';

interface PenaltyStatusFilterProps {
  value: number; // -1, 0, 1
  onChange: (value: number) => void;
}

const PenaltyStatusFilter: React.FC<PenaltyStatusFilterProps> = ({ 
  value, 
  onChange
}) => {
  ...
  return (
    <div className="flex flex-col items-center space-y-2">
      {/* Label */}
      <span className="text-sm font-semibold text-gray-700">Mokesčio statusas</span>
...
export default PenaltyStatusFilter;
